 ...
 *}
 <table class="box" cellspacing="1" cellpadding="0">
	<tr>
		<td class="box_head">Notizen - Ändern</td>
	</tr>
	<tr>
		<td class="box_main">
			<form method="post" action="main.php?action=notes&do=saveedit&id={$note.id}&bmsession={$sid}">
				<table width="100%" cellspacing="1" cellpadding="0" class="folder">
					<tr>
						...
						<td class="td1" height="20" style="text-align:left;"><input type="text" name="betreff" style="width:100%;" value="{$note.betreff}"></td>
					</tr>
					<tr>
						<td class="td2" width="80" height="20" style="text-align:left;" valign="top"><b>&nbsp;Notiz:</b></td>
						<td class="td2" height="20" style="text-align:left;">{$note.editor}</td>
					</tr>
					<tr>
